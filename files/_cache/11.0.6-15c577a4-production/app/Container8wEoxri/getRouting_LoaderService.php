 ...
 */
class getRouting_LoaderService extends Glpi_Kernel_KernelProductionContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('production');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'production'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'production'));
