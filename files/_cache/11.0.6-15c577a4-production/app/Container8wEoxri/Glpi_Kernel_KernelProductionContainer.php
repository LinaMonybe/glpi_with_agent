...
class Glpi_Kernel_KernelProductionContainer extends Container
{
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('+SETQq8xTG', 0, $container->getParameter('container.build_id'), ($container->services['logger'] ?? $container->get('logger', 3)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WyuWndjzN6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['logger'] ?? $container->get('logger', 3)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qvE++gHstH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['logger'] ?? $container->get('logger', 3)));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'glpi.default_secret' => '7e344019e04df4f823bd28e39a1bfdcb6ec4be5ae3f7283e8eb1c3e898f88da7',
